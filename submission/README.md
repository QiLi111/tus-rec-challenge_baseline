...
* We have provided an example docker image [here](#instructions-for-docker), which can predict DDFs on the validation/test dataset. The source code is also available in [`submission`](https://github.com/QiLi111/tus-rec-challenge_baseline/blob/2cbbecb3ee36dd35ef770cc7c8e87e0b6af647bf/submission/) folder.
* The participants are expected to replace the contents of [`predict_ddfs`](https://github.com/QiLi111/tus-rec-challenge_baseline/blob/2cbbecb3ee36dd35ef770cc7c8e87e0b6af647bf/submission/test.py#L40) function in [test.py](https://github.com/QiLi111/tus-rec-challenge_baseline/blob/2cbbecb3ee36dd35ef770cc7c8e87e0b6af647bf/submission/test.py) with their own algorithm. The function is expected to take one entire scan as input, and output four kinds of DDFs. 
...
> [!NOTE]  
> * If you are not sure about data dimensions, coordinate system or transformation direction, etc., please refer to the example code in [`baseline_model`](https://github.com/QiLi111/tus-rec-challenge_baseline/blob/2cbbecb3ee36dd35ef770cc7c8e87e0b6af647bf/submission/baseline_model/Prediction.py) folder.
...
```
Note: If you want to see the plotted trajectories, please uncomments [this]((https://github.com/QiLi111/tus-rec-challenge_baseline/blob/2cbbecb3ee36dd35ef770cc7c8e87e0b6af647bf/submission/test.py#L44)) line.

#### 3. Prepare Dockerfile.
You can start from our example [Dockerfile](https://github.com/QiLi111/tus-rec-challenge_baseline/blob/2cbbecb3ee36dd35ef770cc7c8e87e0b6af647bf/submission/Dockerfile). To use your own environment, you just need to modify the [`requirements.txt`](https://github.com/QiLi111/tus-rec-challenge_baseline/blob/2cbbecb3ee36dd35ef770cc7c8e87e0b6af647bf/submission/requirements.txt) to specify the dependencies.
